...
@Component({
  selector: 'app-empoosedmattress',
  templateUrl: './empoosedmattress.component.html',
  styleUrls: ['./empoosedmattress.component.scss']
})

export class EmpoosedmattressComponent {
